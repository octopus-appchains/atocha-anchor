...
near call f5cfbc74057c610c8ef151a439252680ac68c6dc.factory.bridge.near storage_deposit $ARGS --accountId $ANCHOR_ACCOUNT_ID --deposit 0.0125
#
near call $ANCHOR_ACCOUNT_ID migrate_state '' --accountId $ANCHOR_ACCOUNT_ID --gas 200000000000000
#
ARGS='{"account_id":"'$REGISTRY_ACCOUNT_ID'"}'
near call $ANCHOR_ACCOUNT_ID set_token_price_maintainer_account $ARGS --accountId $ANCHOR_ACCOUNT_ID
#
near call $ANCHOR_ACCOUNT_ID set_price_of_oct_token '{"price":"2740000"}' --accountId $REGISTRY_ACCOUNT_ID
#
near call $ANCHOR_ACCOUNT_ID pause_rewards_withdrawal '' --accountId $ANCHOR_ACCOUNT_ID
